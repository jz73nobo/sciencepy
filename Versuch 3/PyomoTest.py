...
##Comment: pyomo5.6.9 will conflict with pyutilib6.0.0. which leads to errors.
###The version of pyomo imported here has been updated to 5.7.0 for obtaining results.